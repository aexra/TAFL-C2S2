...
### Детерминизация
Представляет из себя страницу с редактором графа и возможностью вывести в два других редактора (только для чтения) процесс детерминизации (S-граф) и детерминированный граф на основе введенного. Весь редактор графов написан вручную из головы без привлечения сторонних решений и предлагает возможность создания вершин, переименования их, удаления, соединения с другими вершинами, перемещения, удаления ребер и задания им весов и пр.<br>
